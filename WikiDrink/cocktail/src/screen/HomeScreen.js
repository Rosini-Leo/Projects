      ...
      <div className="home-hero" >
        <div className="home-hero-text" >
          <div className="home-hero-title" >
            ...
            <p>
            Wiki Drink è un database internazionale che mette a tua disposizione,
            in maniera  
            <span className="brand-color" > Gratuita</span>
            ...
            <div className="home-hero-img home-hero-centered" >
              <Lottie
              width={300}
              height={300}
              options={{
